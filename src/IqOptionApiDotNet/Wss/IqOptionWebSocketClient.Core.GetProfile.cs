...
namespace IqOptionApiDotNet.Ws
{
    public partial class IqOptionWebSocketClient
    {
        ...
        #region [GetCoreProfileClientAsync]
        ...
        /// <returns></returns>
        public Task<Profile> GetCoreProfileClientAsync(string requestId)
        {
            return SendMessageAsync(requestId, new GetCoreProfileClientRequestMessage(), ProfileObservable);
        }
